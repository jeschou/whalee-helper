...
public class DeployLocalAction extends AnAction {
    ...
    public void update(@NotNull AnActionEvent e) {
        ...
        presentation.setText("deploy hmac " + moduleRoot.getName());
    ...
    public void actionPerformed(AnActionEvent event) {
        ...
        String cmd = String.format("gbl -o %s *.go && curl -F \"filename=@%s\" http://hmac:8999/%s/?deploy=local && rm %s", dir.getName(), dir.getName(), dir.getName(), dir.getName());
